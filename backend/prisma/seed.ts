...
async function main() {
  ...
  await prisma.prompt.create({
    data: {
      ...
      Use palavras chamativas que cativam a atenção do leitor.

      Além disso, no final da descrição inclua uma lista de 3 até 10 hashtags em letra minúscula contendo palavras-chaves do vídeo.
